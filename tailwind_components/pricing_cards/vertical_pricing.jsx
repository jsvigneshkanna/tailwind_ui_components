import {stripIndent} from "react-codepen-prefill-embed";
  ...
  <div class="my-10 w-64 max-w-sm rounded-xl border border-gray-200 bg-white shadow-md">
    ...
    <div class="flex flex-col items-center justify-center p-6 text-center">
      ...
      <p class="mb-4 px-8 text-sm font-bold text-gray-500">Organize across all apps by hand</p>

      <div class="mb-3 flex flex-row">
        <h3 class="mx-2 text-4xl font-bold text-blue-700">0</h3>
        <div class="flex flex-col">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-currency-dollar font-bold text-blue-700" viewBox="0 0 16 16">
      ...
      <p class="mb-3 text-sm font-normal text-gray-700">Slate helps you see how many more days you need to work to reach you financial goal for the month and year.</p>
