  ...
  return (
    <div className="flex flex-row w-100 items-center justify-center md:flex-row bg-gradient-to-tr from-[#000855] to-[#690101] py-3 md:py-6">
      <div className=" hidden md9:flex flex-row items-center justify-center">
        <div className="group m-5 inline-block h-16 w-16 py-0 hover:w-52 transition-all ease-out bg-white rounded-full float-left overflow-hidden cursor-pointer">
      ...
      <div className="flex flex-row items-center justify-center">
        <div className="hidden md9:block group m-5 h-16 w-16 py-0 hover:w-52 transition-all ease-out bg-white rounded-full float-left overflow-hidden cursor-pointer">
